...
function portalPage(string $title, string $content): never
{
    ...
    $page = str_replace('</style></head><body><main class="shell">', '</style><link rel="stylesheet" href="/assets/onboarding-portal.css"><link rel="stylesheet" href="/assets/onboarding-wizard.css"></head><body><a class="skip-link" href="#tester-portal">Skip to tester portal</a><main id="tester-portal" class="portal-preview-shell">', $page);
    ...
    $page = str_replace('</main></body></html>', '<script src="/assets/onboarding-wizard.js" defer></script></main></body></html>', $page);
    echo $page;
    exit;
}
