...
function renderPage(string $title, string $content): never
{
    ...
    $styles = <<<'CSS'
:root{color-scheme:dark;--bg:#0b0e14;--surface:#151b26;--surface-2:#0f1520;--border:rgba(255,255,255,.09);--text:#f7f8fc;--muted:#a5afc4;--purple:#9b6dff;--purple-soft:rgba(155,109,255,.16);--teal:#4fe0cf;--warning:#ffcb6b;--danger:#ff7b8a}*{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at top left,#201735 0,transparent 32rem),var(--bg);color:var(--text);font:16px/1.5 Inter,Roboto,system-ui,sans-serif}.shell{max-width:84rem;margin:0 auto;padding:2rem 1.25rem 4rem}a{color:#c2a9ff;text-underline-offset:.18em}h1,h2,h3,h4{line-height:1.15;letter-spacing:-.02em}h1{font-size:clamp(2rem,4vw,3rem);margin:.25rem 0 .75rem}h2{margin:0 0 .45rem;font-size:1.35rem}h3{margin:.1rem 0}.muted{color:var(--muted)}small{color:var(--muted)}section,.card{margin:1rem 0;padding:1.35rem;border:1px solid var(--border);border-radius:1rem;background:rgba(21,27,38,.94);box-shadow:0 18px 45px rgba(0,0,0,.15)}.notice{padding:.85rem 1rem;border:1px solid rgba(79,224,207,.28);border-radius:.7rem;background:rgba(27,84,75,.58)}.error{border-color:rgba(255,123,138,.4);background:rgba(100,38,53,.65)}.warning{padding:.7rem .85rem;border-left:3px solid var(--warning);border-radius:.25rem;background:rgba(82,60,26,.48)}.visually-hidden{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}label{display:block;margin:.9rem 0 .35rem;font-weight:700;font-size:.92rem}input,textarea,select,.editor{box-sizing:border-box;width:100%;padding:.72rem .78rem;border:1px solid #46536b;border-radius:.55rem;background:#f8fafc;color:#172033;font:inherit}input:focus,textarea:focus,select:focus,.editor:focus{outline:3px solid rgba(155,109,255,.45);outline-offset:1px}input[type="checkbox"]{width:auto;padding:0}textarea{min-height:9rem}.toolbar{display:flex;flex-wrap:wrap;gap:.4rem;margin:.35rem 0}.toolbar button{margin:0;padding:.35rem .55rem;background:#e8edf5;color:#182033;font-size:.86rem}.editor{min-height:14rem;overflow:auto}.editor:empty:before{color:#58647a;content:attr(data-placeholder);pointer-events:none}.editor p:first-child{margin-top:0}.editor p:last-child{margin-bottom:0}button,.button{display:inline-flex;align-items:center;justify-content:center;gap:.4rem;margin-top:1rem;padding:.7rem 1rem;border:0;border-radius:.55rem;background:linear-gradient(135deg,#b78cff,#8054ed);color:#150d26;font:800 .94rem Inter,Roboto,system-ui;cursor:pointer;text-decoration:none;transition:transform .15s ease,filter .15s ease}button:hover,.button:hover{transform:translateY(-1px);filter:brightness(1.07)}button.secondary,.button.secondary{margin-left:.5rem;background:#263754;color:#f7f8fc}.button.quiet{background:transparent;border:1px solid var(--border);color:var(--text)}table{width:100%;border-collapse:collapse}th,td{padding:.85rem .7rem;text-align:left;border-bottom:1px solid var(--border);vertical-align:middle}th{font-size:.78rem;letter-spacing:.06em;text-transform:uppercase;color:var(--muted)}tr:last-child td{border-bottom:0}.actions{display:flex;align-items:flex-start;justify-content:space-between;gap:1rem;flex-wrap:wrap}.actions form{margin:0}.product-mark{display:flex;align-items:center;gap:.7rem;color:#d1c0ff;font-weight:700}.product-mark::before{content:'7';display:grid;place-items:center;width:2rem;height:2rem;border-radius:.65rem;background:linear-gradient(135deg,#b78cff,#8054ed);color:#150d26}.app-nav{display:flex;gap:.5rem;flex-wrap:wrap;margin:1.5rem 0 1.25rem;padding:.4rem;border:1px solid var(--border);border-radius:.8rem;background:rgba(15,21,32,.85)}.app-nav a{padding:.55rem .8rem;border-radius:.5rem;text-decoration:none;color:var(--muted);font-weight:700}.app-nav a[aria-current="page"]{background:var(--purple-soft);color:#e5dcff}.dashboard-hero{display:flex;align-items:end;justify-content:space-between;gap:1rem;padding:1.35rem 0 .35rem}.dashboard-hero p{max-width:42rem;margin:0}.onboarding-overview{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:.8rem}.onboarding-metric{padding:1rem;border:1px solid var(--border);border-radius:.75rem;background:var(--surface-2)}.onboarding-metric strong{display:block;font-size:1.75rem;color:var(--teal);line-height:1}.onboarding-metric span{display:block;margin-top:.55rem;font-weight:700}.pipeline{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:.5rem;margin:1rem 0 0}.pipeline-step{padding:.7rem .8rem;border:1px solid var(--border);border-radius:.6rem;background:var(--surface-2);font-size:.9rem}.pipeline-step b{display:block;color:var(--teal);font-size:.75rem;text-transform:uppercase;letter-spacing:.06em}.roster-toolbar{display:flex;align-items:center;justify-content:space-between;gap:.75rem;flex-wrap:wrap;margin:1rem 0}.roster-search{max-width:25rem;margin:0;background:var(--surface-2);color:var(--text)}.roster-filters{display:flex;gap:.4rem;flex-wrap:wrap}.filter-button{margin:0;padding:.45rem .7rem;background:transparent;border:1px solid var(--border);color:var(--muted);font-size:.8rem}.filter-button[aria-pressed="true"]{background:var(--purple-soft);border-color:rgba(155,109,255,.5);color:#e5dcff}.roster-table-wrap{overflow-x:auto}.roster-row{transition:background .15s ease}.roster-row:hover{background:rgba(155,109,255,.07)}.onboarding-status{display:inline-block;padding:.22rem .55rem;border:1px solid rgba(155,109,255,.35);border-radius:99px;background:var(--purple-soft);color:#e5dcff;font-size:.78rem;font-weight:800}.profile-missing{margin:.65rem 0;padding:.65rem;border-left:3px solid var(--warning);background:rgba(82,60,26,.48)}.profile-complete{margin:.65rem 0;padding:.65rem;border-left:3px solid var(--teal);background:rgba(27,84,75,.4)}.mutation-authorization{padding:.65rem;border-left:3px solid var(--warning);background:rgba(82,60,26,.48)}.task-preview{min-height:3rem;padding:.8rem;border:1px solid var(--border);border-radius:.55rem;background:var(--surface-2);color:var(--muted)}.task-preview strong{color:var(--text)}.action-impact{margin:1rem 0 0;padding:.7rem .85rem;border-radius:.55rem;border:1px solid rgba(155,109,255,.32);background:var(--purple-soft);color:#e5dcff;font-weight:700}.assignment-existing,.onboarding-card{min-width:0;margin:1rem 0;padding:1rem;border:1px solid var(--border);border-radius:.7rem;background:var(--surface-2)}.assignment-existing textarea,.onboarding-card textarea{min-height:5rem}.inline-form{margin-top:.5rem}@media(max-width:50rem){.shell{padding:1.2rem .9rem 3rem}.onboarding-overview,.pipeline{grid-template-columns:repeat(2,minmax(0,1fr))}.dashboard-hero{align-items:flex-start;flex-direction:column}table{font-size:.9rem}.optional{display:none}}@media(max-width:32rem){.onboarding-overview,.pipeline{grid-template-columns:1fr}.app-nav a{width:100%;text-align:center}.button,button{width:100%;margin-left:0!important}}
CSS;
    echo '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>'
        . e($title) . '</title><style>' . $styles . '</style></head><body><main class="shell">'
...
{
    $tasks = taskRegistry();
    $testers = $database->query("SELECT testers.*, onboarding.onboarding_status, onboarding.orientation_email_status, onboarding.orientation_email_attempted_at, onboarding.orientation_email_attempts, onboarding.play_opt_in_confirmed_at FROM testers LEFT JOIN tester_onboarding AS onboarding ON onboarding.tester_id = testers.id WHERE testers.status = 'active' ORDER BY testers.received_at, testers.id")->fetchAll();
    $assignments = $database->query("SELECT assignments.id, assignments.tester_id, assignments.task_id, assignments.task_status, assignments.station_scope, assignments.created_at, testers.display_name, testers.device, testers.android_version FROM tester_task_assignments AS assignments JOIN testers ON testers.id = assignments.tester_id WHERE testers.status = 'active' ORDER BY assignments.created_at DESC, assignments.id DESC")->fetchAll();
    $feedback = $database->query("SELECT feedback.id, feedback.tester_id, feedback.assignment_id, feedback.subject, feedback.outcome, feedback.created_at, testers.display_name, assignments.task_id FROM tester_feedback AS feedback JOIN testers ON testers.id = feedback.tester_id LEFT JOIN tester_task_assignments AS assignments ON assignments.id = feedback.assignment_id WHERE testers.status = 'active' ORDER BY feedback.created_at DESC, feedback.id DESC")->fetchAll();
    $assignmentCounts = [];
    ...
    if (!in_array($view, ['overview', 'roster', 'assignments', 'feedback', 'communications'], true)) {
        $view = 'overview';
    }
    $assignmentRows = '';
    foreach ($assignments as $assignment) {
        $task = $tasks[$assignment['task_id']] ?? null;
        $taskName = is_array($task) ? $task['id'] . ' — ' . $task['title'] : (string) $assignment['task_id'];
        $assignmentRows .= '<tr><td><strong>' . e($taskName) . '</strong><br><small>' . e((string) $assignment['station_scope']) . '</small></td><td><strong>' . e($assignment['display_name']) . '</strong><br><small>' . e($assignment['device'] . ' · ' . $assignment['android_version']) . '</small></td><td>' . e(ucwords(str_replace('_', ' ', (string) $assignment['task_status']))) . '</td><td><small>' . e((string) $assignment['created_at']) . '</small></td><td><a href="/private-tester-queue.php?tester=' . (int) $assignment['tester_id'] . '">Manage</a></td></tr>';
    }
    $feedbackRows = '';
    foreach ($feedback as $report) {
        $feedbackRows .= '<tr><td><strong>' . e($report['subject']) . '</strong><br><small>' . e((string) ($report['task_id'] ?: 'General feedback')) . '</small></td><td>' . e($report['display_name']) . '</td><td><span class="onboarding-status">' . e(ucfirst((string) $report['outcome'])) . '</span></td><td><small>' . e((string) $report['created_at']) . '</small></td><td><a href="/private-tester-queue.php?tester=' . (int) $report['tester_id'] . '">Open workspace</a></td></tr>';
    }
    $rows = '';
    foreach ($testers as $tester) {
        ...
        $optInText = is_string($tester['play_opt_in_confirmed_at'] ?? null) && $tester['play_opt_in_confirmed_at'] !== ''
            ? 'Tester-confirmed Play opt-in · ' . $tester['play_opt_in_confirmed_at']
            : 'Play opt-in not yet tester-confirmed';
        $taskText = ($assignmentCounts[$id] ?? 0) === 0 ? 'No focused task' : ($assignmentCounts[$id] . ' focused task' . ($assignmentCounts[$id] === 1 ? '' : 's'));
        $rows .= '<tr class="roster-row" data-roster-row data-stage="' . e($status) . '" data-search="' . e(strtolower($tester['display_name'] . ' ' . $tester['email'] . ' ' . $tester['device'] . ' ' . $tester['android_version'])) . '"><td><strong>' . e($tester['display_name']) . '</strong><br><small>' . e($tester['email']) . '</small></td><td>' . e($tester['device']) . '<br><small>' . e($tester['android_version']) . '</small></td><td>' . onboardingBadge($status) . '<br><small>' . e($profileText) . '</small><br><small>' . e($optInText) . '</small></td><td><small>' . e($taskText) . '</small></td><td><a class="button quiet" href="/private-tester-queue.php?tester=' . $id . '">Manage</a><br><a href="/tester-portal.php?preview_tester=' . $id . '">Preview tester view</a></td></tr>';
    }
    ...
    $navigation = '<nav class="app-nav" aria-label="Coordinator workspace"><a href="/private-tester-queue.php?view=overview"' . ($view === 'overview' ? ' aria-current="page"' : '') . '>Overview</a><a href="/private-tester-queue.php?view=roster"' . ($view === 'roster' ? ' aria-current="page"' : '') . '>Tester roster <span aria-label="active testers">(' . count($testers) . ')</span></a><a href="/private-tester-queue.php?view=assignments"' . ($view === 'assignments' ? ' aria-current="page"' : '') . '>Assignments (' . count($assignments) . ')</a><a href="/private-tester-queue.php?view=feedback"' . ($view === 'feedback' ? ' aria-current="page"' : '') . '>Feedback (' . count($feedback) . ')</a><a href="/private-tester-queue.php?view=communications"' . ($view === 'communications' ? ' aria-current="page"' : '') . '>Communications</a><a href="/private-tester-queue.php?mail_archive=1">Sent archive (' . $archiveCount . ')</a></nav>';
    $overview = '<section><h2>Onboarding pipeline</h2><p class="muted">A clear handoff from complete tester information to one focused assignment.</p><div class="onboarding-overview"><a class="onboarding-metric" href="/private-tester-queue.php?view=roster&amp;stage=profile_pending"><strong>' . $metrics['profile_pending'] . '</strong><span>Profile updates needed</span></a><a class="onboarding-metric" href="/private-tester-queue.php?view=roster&amp;stage=profile_complete"><strong>' . $metrics['profile_complete'] . '</strong><span>Ready to invite</span></a><a class="onboarding-metric" href="/private-tester-queue.php?view=roster&amp;stage=orientation_sent"><strong>' . $metrics['orientation_sent'] . '</strong><span>Orientation sent</span></a><a class="onboarding-metric" href="/private-tester-queue.php?view=roster&amp;stage=ready"><strong>' . $metrics['ready'] . '</strong><span>Ready for assignment</span></a></div><div class="pipeline"><div class="pipeline-step"><b>1</b>Collect coverage</div><div class="pipeline-step"><b>2</b>Invite and orient</div><div class="pipeline-step"><b>3</b>Confirm readiness</div><div class="pipeline-step"><b>4</b>Assign focused work</div></div><p><a class="button quiet" href="/private-tester-queue.php?view=roster">Open the tester roster</a></p></section>';
    $roster = '<section><div class="actions"><div><h2>Tester roster</h2><p class="muted">Search the active roster, then open a focused workspace for onboarding, assignments, mail history, and the tester-facing preview.</p></div><a class="button quiet" href="/private-tester-queue.php?view=communications">Compose email</a></div><div class="roster-toolbar"><input class="roster-search" data-roster-search type="search" placeholder="Search tester, device, or Android version" aria-label="Search tester roster"><div class="roster-filters" role="group" aria-label="Filter onboarding stage"><button class="filter-button" type="button" data-roster-filter="all" aria-pressed="true">All</button><button class="filter-button" type="button" data-roster-filter="profile_pending" aria-pressed="false">Needs profile</button><button class="filter-button" type="button" data-roster-filter="profile_complete" aria-pressed="false">Ready to invite</button><button class="filter-button" type="button" data-roster-filter="orientation_sent" aria-pressed="false">Oriented</button><button class="filter-button" type="button" data-roster-filter="ready" aria-pressed="false">Ready</button></div></div><p class="muted" data-roster-count></p><div class="roster-table-wrap"><table><thead><tr><th scope="col">Tester</th><th scope="col">Device</th><th scope="col">Onboarding</th><th scope="col">Assignments</th><th scope="col"><span class="visually-hidden">Open</span></th></tr></thead><tbody>' . $rows . '</tbody></table></div></section>';
    $assignmentView = '<section><div class="actions"><div><h2>Focused assignments</h2><p class="muted">Assignments are created only from a tester workspace, after their profile and opt-in are ready. This view tracks the portfolio across the cohort.</p></div><a class="button quiet" href="/private-tester-queue.php?view=roster&amp;stage=ready">View ready testers</a></div><div class="roster-table-wrap"><table><thead><tr><th scope="col">Task</th><th scope="col">Tester / device</th><th scope="col">Status</th><th scope="col">Assigned</th><th scope="col"><span class="visually-hidden">Open</span></th></tr></thead><tbody>' . ($assignmentRows === '' ? '<tr><td colspan="5" class="muted">No focused Tester Tasks are assigned yet.</td></tr>' : $assignmentRows) . '</tbody></table></div></section>';
    $feedbackView = '<section><div class="actions"><div><h2>Tester reports</h2><p class="muted">Results submitted through the tester portal, grouped here for coordinator triage without exposing reports to other testers.</p></div><a class="button quiet" href="/private-tester-queue.php?view=assignments">Review assignments</a></div><div class="roster-table-wrap"><table><thead><tr><th scope="col">Report</th><th scope="col">Tester</th><th scope="col">Outcome</th><th scope="col">Submitted</th><th scope="col"><span class="visually-hidden">Open</span></th></tr></thead><tbody>' . ($feedbackRows === '' ? '<tr><td colspan="5" class="muted">No tester reports have been submitted yet.</td></tr>' : $feedbackRows) . '</tbody></table></div></section>';
    $communications = '<section><h2>Compose a coordinator email</h2><p class="muted">Each recipient receives an individual multipart email. You will review the recipients and rendered message before any delivery is attempted.</p><form method="post" id="email-form"><input type="hidden" name="action" value="prepare"><input type="hidden" name="csrf" value="' . e(csrf()) . '"><p><label><input type="checkbox" id="select-all"> Select all active testers</label></p><div class="roster-table-wrap"><table><thead><tr><th scope="col">Select</th><th scope="col">Tester</th><th scope="col">Onboarding</th></tr></thead><tbody>' . implode('', array_map(static fn (array $tester): string => '<tr><td><input aria-label="Select ' . e($tester['display_name']) . '" type="checkbox" name="tester_ids[]" value="' . (int) $tester['id'] . '"></td><td>' . e($tester['display_name']) . '<br><small>' . e($tester['email']) . '</small></td><td>' . onboardingBadge(onboardingStatus($tester)) . '</td></tr>', $testers)) . '</tbody></table></div><label for="subject">Subject</label><input id="subject" name="subject" maxlength="' . MAX_SUBJECT_LENGTH . '" required>' . $editor . '<button type="submit">Review selected recipients</button></form></section>';
    $body = match ($view) {
        'roster' => $roster,
    ...
    $content = '<div class="actions"><div><div class="product-mark">24Seven.FM Player · Closed Alpha</div><div class="dashboard-hero"><div><h1>Tester operations</h1><p class="muted">Coordinate onboarding, focused testing, and individual communications without exposing tester information to the cohort.</p></div></div></div><form method="post"><input type="hidden" name="action" value="logout"><input type="hidden" name="csrf" value="' . e(csrf()) . '"><button class="secondary" type="submit">Sign out</button></form></div>' . $navigation . $message . $body . '<script src="/assets/private-tester-queue.js?v=operations-3" defer></script>';
