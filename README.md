...
| --- | --- | --- | --- | --- |
| M23.1 Current-head signed release candidate | M | 2–4 hours | 🚧 Local audit and memory-backed Linux signer green; protected run/Play pending ([evidence](docs/m23-release-candidate-audit.md)) | Commit `041a811` production identity, manifest, dependencies/notices, explicit backup exclusions, release builds, and 16 KB APK/ELF packaging pass; use the existing encrypted recovery package through the Linux helper, confirm version-code availability, and validate Play delivery/update |
