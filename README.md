...
| Milestone | Size | Estimate | Status | Outcome |
| --- | --- | --- | --- | --- |
| M23 Alpha distribution readiness | M | 1–2 focused days | 🚧 In progress | Play assets/declarations, modern-device tests, protected signing/recovery, and signed-candidate validation are green; the owner-selected off-PC backup, public privacy hosting, reviewer/audience/contact details, and tester setup remain |
