...
The canonical roadmap now runs from **M01 through M60**. **M01–M35 are complete**, preserving 35 verified achievements. Closed-app notification delivery **M36–M38 is deferred** unless JERIC authorizes an official station-app program; candidate delivery and publication are **M39–M41**.

> [!IMPORTANT]
> **Current focus:** M36–M38 closed-app notifications are deferred unless JERIC authorizes an official station-app program. M39–M41 retain their candidate, Play-delivery, and explicit-publication gates.
