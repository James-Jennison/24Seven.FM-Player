...
| M29 | Play Declarations, Privacy, and Data Safety | Waiting externally | Retention/deletion/processor/IP policy, account boundary, and five-station reviewer clean-install access are documented; PT-35 exact-candidate reconciliation, audience/content/UGC classification, final media-playback video, and saved Console/privacy consistency remain | Conditional · 2–5 active days |
