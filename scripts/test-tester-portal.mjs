...
assert(portal.includes("const PORTAL_WORKSPACE_VIEWS") && portal.includes("function portalWorkspaceNavigation") && portal.includes('data-portal-view'), "Completed tester workspaces must have explicit, authenticated route-based navigation.");
