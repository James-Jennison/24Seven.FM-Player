...
expectIntake(FORM_ORIGIN . FALLBACK_LOCATION . '#alpha-tester-interest' === 'https://24sevenfmplayer.com/product-testing/#alpha-tester-interest', 'The alpha-tester application endpoint must remain anchored to the canonical Player route.');
